''
'' ucbez3d.bas -- quadric bezier curve generation ex.
''                Demonstrates how to use ugluQuadricBez3D to get the
''                X, Y and Z coordinates for a quadric curve.
''
''
...
'':::
    Dim video As Long
    Dim qbz As QUADBEZ3D
    Dim qbzex As QUADBEZ
    ...
    '' Copy it to qbzex for drawing
    qbzex.a.x = qbz.a.x: qbzex.a.y = qbz.a.y
    qbzex.b.x = qbz.b.x: qbzex.b.y = qbz.b.y
    qbzex.c.x = qbz.c.x: qbzex.c.y = qbz.c.y

    '' tell ugluQuadricBez3D to generate the curve
    '' with points precision.
    ugluQuadricBez3D curve(0), qbz, POINTS
    ...
    Do
        ...
        uglQuadricBez video, qbzex, POINTS, UGL.WHITE16
