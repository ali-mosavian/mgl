;;
;; 8line.asm -- 8-bit low-color DCs line drawing routine
;;
...
;;      di= y1
;;      eax= m
b8_xLine        proc    far public uses bp es,\
...
;;      di= y1
;;      eax= m
b8_yLine        proc    far public uses bp es,\
...
b8_xyLine       proc    far public uses bp es,\ 
                        yInc:word, color:dword
...
;;      di= y1
;;      bp= yInc
b8_dLine        proc    far public uses bx si es
