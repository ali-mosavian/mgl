...
algn_v_msk:     and     si, __IMM16__
                ...
                ;;
@@noalign:      fadd    ss:dudx16               ;; u' v' z'
                fxch    st(1)                   ;; v' u' z'
                fadd    ss:dvdx16               ;; v' u' z'
                fxch    st(2)                   ;; z' u' v'
                fadd    ss:dzdx16               ;; z' u' v'
                fxch    st(2)                   ;; v' u' z'
                fxch    st(1)                   ;; u' v' z'
...
b8_HLineTP	proc    near public uses ebx esi edi bp
                ...
                fmul    ss:_16_0                ;; dudx16 dudx dvdx dzdx
                fld     st(2)                   ;; dvdx dudx16 dudx dvdx dzdx
                fmul    ss:_16_0                ;; dvdx16 dudx16 dudx dvdx dzdx
                fld     st(4)                   ;; dzdx dvdx16 dudx16 dudx dvdx dzdx
                fmul    ss:_16_0                ;; dzdx16 dvdx16 dudx16 dudx dvdx dzdx
                fxch    st(2)                   ;; dudx16 dvdx16 dzdx16 dudx dvdx dzdx
                
                fstp    ss:dudx16               ;; dvdx16 dzdx16 dudx dvdx dzdx
                fstp    ss:dvdx16               ;; dzdx16 dudx dvdx dzdx
                fstp    ss:dzdx16               ;; dudx dvdx dzdx
