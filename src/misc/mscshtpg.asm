;;
;; Sutherland-Hodgeman polygon clipping (tmapped perspective gouraud-shaded)
;;
;;      s in  & e out -> s, i
;;      s in  & e in  -> s
;;      s out & e in  -> i
...
;;       nov/03 update  [Blitz]
                ...
                F2FX_tpg2d      proto   near :near ptr VEC3F, :near ptr VEC3FX
...
;;      ds-> vtxfx
;;      gs-> tex
F2FX_tpg2d      proc    near uses eax bx edx di,\
                        vtx:near ptr VEC3F,\
