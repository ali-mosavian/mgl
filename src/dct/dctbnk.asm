...
;;	ax-> /       /    / 	      (read  /     )
bnk_RdWrBegin	proc    near public
...
;;  in: bx-> gfxCtx[dst.type]
;;	edi= dst.addrTb[y]
bnk_RdWrSwitch	proc    near public uses bx si
...
bnk_RdAccess    proc    near public uses bx
...
bnk_WrAccess    proc    near public uses bx
...
;;	ax= /   /	seg (read  /     )
bnk_RdWrAccess	proc    near public uses bx si
