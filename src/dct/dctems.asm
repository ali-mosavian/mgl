...
;;	ax-> /	     /	  / 	      (read  /	   )
ems_RdWrBegin	proc    near public
                mov     bx, O em$emsCtx.wrCurrent
...
;;  in: bx-> gfxCtx[dst.type]
;;	edi= dst.addrTb[y]
ems_RdWrSwitch	proc    near public
                mov     ss:em$emsCtx.wrCurrent, di
                PS      ax, bx, cx, dx
                EMS_MAP EMS_WRITEPAGE
                PP      dx, cx, bx, ax
...
;;	ax= /   /       /   (read  /	 )
ems_RdWrAccess	proc    near public
...
;;
;; out: ds:si-> src framebuffer
ems_FullAccess  proc    near public uses ax bx ecx dx di bp
