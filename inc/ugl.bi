...
Declare Sub      uglTriFM       (Byval dstDC As Long, _
                                 seg vtx As TriType, _
                                 byval col as long)

Declare Sub      uglTriGM       (Byval dstDC As Long, _
                                 seg vtx As TriType, _
                                 byval cnt as integer)


Declare Sub      uglTriTM       (Byval dstDC As Long, _
                                 seg vtx As TriType, _
                                 byval cnt as integer, _
                                 Byval mask As Integer, _
                                 Byval srcDC As Long)                                 

Declare Sub      uglTriTPM      (Byval dstDC As Long, _
                                 seg vtx As TriType, _
                                 byval cnt as integer, _
                                 Byval mask As Integer, _
                                 Byval srcDC As Long)
